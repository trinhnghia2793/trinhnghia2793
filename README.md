...
<p>
I'm a Fullstack Web Developer passionate about building modern web applications and continuously exploring new technologies.

My experience started with PHP and Laravel, then expanded to React, Node.js, Express.js, and MongoDB through personal projects and hands-on learning. Currently, I'm focusing on modern JavaScript/TypeScript ecosystems, particularly Next.js and NestJS, while continuously strengthening my backend and system design knowledge.

I actively leverage AI tools for learning, research, debugging, and improving development workflows, allowing me to learn faster and work more efficiently.
</p>

---

### 📌 My Journey
- Started learning web development in 2024
- Built web applications using PHP and Laravel
- Expanded into React and modern frontend development
- Developed fullstack projects with Node.js, Express.js, and MongoDB
- Implemented authentication systems using JWT and API documentation with Swagger
- Currently exploring Next.js, NestJS, and modern fullstack architectures
- Actively using AI-assisted workflows for research, learning, and software development
